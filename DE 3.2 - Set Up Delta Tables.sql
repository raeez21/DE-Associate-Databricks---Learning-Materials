...
-- MAGIC display(dbutils.fs.ls(DA.paths.datasets+"/ecommerce/raw/sales-historical"))
...
describe detail sales_unparsed
...
describe table extended sales_tmp_vw
...
describe table extended purchase_dates
...
SELECT CAST(CAST((600000000 / 1000000.0) AS TIMESTAMP) AS DATE);

-- COMMAND ----------

-- This works
INSERT INTO purchase_dates VALUES
(1, 600000000, 42.0, Date "1970-01-01")
...
ALTER TABLE purchase_dates ADD CONSTRAINT valid_date CHECK (date <  '2024-01-01');
...
SELECT * FROM users_pii
where source_file like("%part-00003%");
...
-- MAGIC %python
-- MAGIC display(dbutils.fs.ls(f"{DA.paths.datasets}/ecommerce/raw/users-historical/"))
