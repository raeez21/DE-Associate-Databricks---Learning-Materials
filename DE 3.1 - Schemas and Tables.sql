...
--- creating a managed table from data from a csv file
...
CREATE OR REPLACE TABLE table_t AS
  SELECT * FROM temp_delays;


-- COMMAND ----------

DESCRIBE TABLE EXTENDED table_t;

-- COMMAND ----------

DESCRIBE DETAIL table_t;
...
-- MAGIC %python
-- MAGIC display(dbutils.fs.ls("dbfs:/user/hive/warehouse/mohammadraeezmec_xfot_da_delp_default_location.db/table_t"))
...
-- MAGIC %python
-- MAGIC
-- MAGIC dbutils.fs.ls("dbfs:/user/hive/warehouse/mohammadraeezmec_xfot_da_delp_default_location.db")
